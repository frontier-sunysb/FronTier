...
c   u     : double precision value, specifying the requested profile.
...
c
c  output parameters:
c   cu    : double precision array of dimension (nu).
...
c  ..scalar arguments..
      ...
      double precision u
c  ..array arguments..
      double precision tx(nx),ty(ny),c((nx-kx-1)*(ny-ky-1)),cu(nu)
c  ..local scalars..
