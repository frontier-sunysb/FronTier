...
c  ..
c  ..scalar arguments..
      double precision xb,xe,yb,ye,s,eta,tol,fp,fp0
...
c  ..local scalars..
      double precision acc,arg,cos,dmax,fac1,fac2,fpmax,fpms,
     * f1,f2,f3,hxi,p,pinv,
...
c  ..local arrays..
      double precision hx(6),hy(6)
c  ..function references..
      double precision abs,fprati,dsqrt
      integer min0
