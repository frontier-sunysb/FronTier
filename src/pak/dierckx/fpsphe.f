...
c  ..scalar arguments..
     ...
     * nt,np,lwrk,ier
      double precision s,eta,tol,fp,sup
c  ..array arguments..
      double precision teta(m),phi(m),r(m),w(m),tt(ntest),
     * tp(npest),c(nc),
...
c  ..local scalars..
      double precision aa,acc,arg,cn,co,c1,dmax,d1,d2,eps,
     * facc,facs,fac1,fac2,fn,
     ...
     * num1,rank
c  ..local arrays..
      double precision ht(4),hp(4)
c  ..function references..
      double precision abs,atan,fprati,dsqrt,cos,sin
      integer min0
