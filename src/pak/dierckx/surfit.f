...
c          in most practical situation nxest = kx+1+dsqrt(m/2), nyest =
c          ky+1+dsqrt(m/2) will be sufficient. see also further comments.
...
c  ..array arguments..
      double precision x(m),y(m),z(m),w(m),tx(nmax),ty(nmax),
