...
c   u     : double precision array of dimension at least (m). in case ipar=1,before
...
c   ub,ue : double precision values. on entry (in case ipar=1) ub and ue must
