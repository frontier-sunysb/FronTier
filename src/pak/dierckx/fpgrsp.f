...
c  ..local scalars..
      double precision arg,co,dr01,dr02,dr03,dr11,dr12,dr13,
     * fac,fac0,fac1,pinv,piv,
...
c  ..local arrays..
      double precision h(5),h1(5),h2(4)
