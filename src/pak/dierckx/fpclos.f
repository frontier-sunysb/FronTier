...
c  ..array arguments..
      double precision u(m),x(mx),w(m),t(nest),c(nc),fpint(nest),
     * z(nc),a1(nest,k1),a2(nest,k),b(nest,k2),
     * g1(nest,k2),g2(nest,k1),q(m,k1)
      integer nrdata(nest)
c  ..local scalars..
      double precision acc,cos,d1,fac,fpart,fpms,fpold,fp0,f1,f2,f3,
     * p,per,pinv,piv,
     ...
     * nrint,n10,n11,n7,n8
c  ..local arrays..
      double precision h(6),h1(7),h2(6),xi(10)
