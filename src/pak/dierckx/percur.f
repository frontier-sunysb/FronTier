...
c   wrk   : double precision array of dimension at least (m*(k+1)+nest*(8+5*k)).
...
c   y(i), a good s-value should be found in the range (m-dsqrt(2*m),m+
c   dsqrt(2*m)). if nothing is known about the statistical error in y(i)
