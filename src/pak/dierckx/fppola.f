...
c  ..array arguments..
      ...
      double precision u(m),v(m),z(m),w(m),tu(nuest),tv(nvest),
     * c(nc),fpint(intest),
...
c  ..local scalars..
      double precision acc,arg,co,c1,c2,c3,c4,dmax,eps,fac,fac1,
     * fac2,fpmax,fpms,
     ...
     * numin,nvmin,rank,iband1
      integer jlu
c  ..local arrays..
      double precision hu(4),hv(4)
c  ..function references..
      double precision abs,atan,cos,fprati,sin,dsqrt
      integer min0
