...
/*! \fn void FT_MakeCuboidSurf(Front *front,double *center,double *edge,COMPONENT neg_comp,COMPONENT pos_comp,int w_type,int refinement_level,SURFACE **surf)
 *  \ingroup INSERT
    ...
    \param pos_comp @b in index for positive side of the surface (outer side).
    \param w_type @b in wave type of the surface.
    \param refinement_level @b in refinement level of the surface.
    \param surf @b out surface made by this function
*/
