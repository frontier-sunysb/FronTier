...
CIM_PARAB_SOLVER::CIM_PARAB_SOLVER(Front &front):front(&front)
{
}

void CIM_PARAB_SOLVER::set_solver_domain(void)
{
...
void CIM_PARAB_SOLVER::solve(double *soln)
{
	switch (dim)
	{
	case 1:
...
void CIM_PARAB_SOLVER::solve1d(double *soln)
{
}	/* end solve1d */

void CIM_PARAB_SOLVER::solve2d(double *soln)
{
...
void CIM_PARAB_SOLVER::solve3d(double *soln)
{
...
int CIM_PARAB_SOLVER::Generate_Domain_and_NB()
{
...
void CIM_PARAB_SOLVER::Set_Intersection()
{
...
int CIM_PARAB_SOLVER::Check_Type_k(int k)
{
    	int Max, Min, SD[MAXD];
...
int CIM_PARAB_SOLVER::Check_Type()
{
    	int k,ii,jj,kk;
...
int CIM_PARAB_SOLVER::Search_Ghost_Value(int k)
{
    	int i, j, k0, k1;
    	D[k] = -D[k];
    	for (i = 0; i < 2*dim; ++i) 
...
int CIM_PARAB_SOLVER::HCIM_Matrix_Generation()
{
	int ii,jj,kk,k,n;
...
int CIM_PARAB_SOLVER::HCIM_Matrix_Generation_k(
	int k,
	int *n)
{
...
void CIM_PARAB_SOLVER::cimSolveFrontState()	
{
...
void CIM_PARAB_SOLVER::cimIntfcPointState(
	double *coords,
	int comp,
	double *ul,
	double *ur)
